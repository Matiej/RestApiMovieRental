...
//            BlueRayMovie movie = blueRayService.findBlueRaById(id);
////            Movie movie1 = blueRayService.findBlueRaById(id);
//            wishListService.addWish(wishListMapper.mapBlueRayMoviesToWishList(movie));
//            model.addAttribute("wishessList", wishListService.findAllBlueRay());
...
//
//    @GetMapping("/wishlist")
//    public String findAllBlueRay(Model model){
//        model.addAttribute("wishessList", wishListService.findAllBlueRay());
//        return "moviesWishList";
//    }
//
